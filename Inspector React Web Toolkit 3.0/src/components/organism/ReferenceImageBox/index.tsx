...
export default function ReferenceImageBox(props: Props) {
    const { getMode, setMode, width, height = 480, updateRecipe, getActiveRecipeNumber, getRecipes, getRecipeImage, getActiveRecipeImage, getRecipesNames } = props;
    ...
    const getImages = async () => {
        ...
        const recipes: RecipeVariant[] = recipeImages.map((item, id) => {return { image: { src: item }, name: `${recipeNames[id]}`, isActive: (id === currentReferenceNumber? true : false)}})
